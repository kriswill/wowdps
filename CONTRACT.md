...
<tr><td>R9</td><td>Deaths & recap</td><td>First-death order; per-player 32-event ring (damage w/o absorbed part + gains), drained at UNIT_DIED, SPELL_INSTAKILL is a recap entry for the health it took. latest death wins; recap newest-first with hp/gain; never opens a segment.</td><td>Break recap parity between lazy and full replay, or reorder the Deaths view.</td></tr>
