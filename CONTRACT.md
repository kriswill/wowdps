...
pub enum Event {
    ...
    AuraRefresh { src: Unit, dst: Unit, spell: Spell, aura_type: AuraType }, // R18: SPELL_AURA_REFRESH, the applied shape; only role spans read it (a refresh with no open span = the buff predates the segment); never opens a segment, never an R8 signal
...
## Wire protocol (owner: proto) — `PROTO_VERSION = 25`
