...
* [taken.txt](taken.md) - Three players, every miss kind, staggered hits and a pet hit before its summon — the destination-side Taken view and per-player mitigation.
